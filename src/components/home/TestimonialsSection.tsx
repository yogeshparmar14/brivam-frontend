...
const testimonials = [
  {
    ...
    rating: 5,
    text: "BRIVAM Whey is honestly the best I've tried. Mixes perfectly, tastes great, and I can see real gains. Made in India and proud of it!",
    city: 'Mumbai',
  },
  {
    name: 'Priya Nair',
    role: 'Fitness Coach',
    rating: 5,
    text: "I recommend BRIVAM to all my clients. The transparent labeling gives me confidence — no hidden fillers, just pure quality protein.",
    city: 'Bangalore',
  },
  {
    name: 'Arjun Singh',
    ...
    rating: 5,
    text: "Switched from international brands to BRIVAM 6 months ago. Better value, same quality, faster delivery. Absolutely no complaints.",
    city: 'Delhi',
  },
  {
    name: 'Kavita Reddy',
